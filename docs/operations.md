...
补数据和补 AI 成功均计为新增，全部已有的日期不展示；整体重试按粒度、日期范围和商品对去重，保留本次已成功的新增结果。周报和月报仅在实际生成成功时分别展示周期范围及新增数量，没有新增的周月报不展示。
...
完成通知的周月报结果示例（没有实际新增的区块省略）：

```text
周报
2026-08-31～2026-09-06：新增 3

月报
2026-08-01～2026-08-31：新增 2
```
