...
6. 页头按本品 SPU 分组，宽屏一行展示本品与一至两个竞品，右侧提供周期与 SKU 操作；单竞品只展示两个商品块，小屏换行。点击本品名称、ID、箭头或空白区域打开选择菜单；点击竞品名称、ID、圆点或空白区域切换分析，选中项有边框与勾选标记。只有商品主图跳转京东，菜单内的主图随选项一起切换本品。商品数量以已有报告为准。
7. 其他周期的完整报告只在用户选择对应周期后加载。
8. 切换本品或竞品保留已选日期范围及日、周、月粒度。对应周期没有报告时展示空状态，日历保留该周期并允许浏览其他有报告的月份，不自动跳到最新报告。
